    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#0b76b6',
                data: [1978796, 1921758, 1920472, 1952324, 1943823, 1913475, 1947945, 1932404, 1827688, 1826143, 1832153, 1834781],
            }]
        },
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#F0B41A',
                data: [136472, 133365, 132190, 136057, 135051, 132765, 137141, 135643, 128342, 128166, 127705, 128294],
            }]
        },
        // Configuration options go here
        options: {
...
if ($('#coin_sales3').length) {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: "litecoin",
                backgroundColor: "rgba(173, 250, 137,0.1)",
                borderColor: '#03f930',
                fill: true,
                data: [7829, 7590, 7726, 7892, 7772, 7745, 8058, 7846, 7401, 7296, 7352, 7154],
            }]
        },
        // Configuration options go here
        options: {
...
if ($('#coin_sales4').length) {
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: "Dogecoin",
                backgroundColor: "rgba(251, 164, 251,0.1)",
                borderColor: '#ee82ee',
                fill: true,
                data: [7, 6.72, 6.70, 6.82, 6.73, 6.68, 6.76, 6.63, 6.29, 6.19, 6.12, 6.14],
            }]
        },
        // Configuration options go here
        options: {
